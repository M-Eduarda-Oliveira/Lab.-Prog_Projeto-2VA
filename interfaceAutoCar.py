...
# Iniciando Janelas
janelaInit, janelaEscolha, janelaAdd, janelaVeriCads, janelaExcluirAuto, janelaMudarValor, janelaVenda, janelaAvista, janelaParcelado = janelaInicio(
...
while True:
    ...
    if window == janelaEscolha and event == sg.WIN_CLOSED or event == '6 - Sair':
        break
...
# Funções dos botões da tela:
    ...
    # Voltar para o menu
    if window == janelaAdd and event == sg.WIN_CLOSED or event == 'Voltar':
        janelaAdd.close()
    ...
    # Voltar para o menu
    if window == janelaVeriCads and event == sg.WIN_CLOSED or event == 'Voltar':
    ...
    # Voltar para o menu
    if window == janelaExcluirAuto and event == sg.WIN_CLOSED or event == 'Voltar':
    ...
    # Voltar para o menu
    if window == janelaMudarValor and event == sg.WIN_CLOSED or event == 'Voltar':
        janelaMudarValor.close()
        janelaEscolha.un_hide()
    if window == janelaMudarValor and event == 'Modificar valor':
        sg.popup("Automóvel com valor modificado!")

    # Ifs da página de vendas
    # Voltar para o menu
    if window == janelaVenda and event == sg.WIN_CLOSED or event == 'Voltar':
        janelaVenda.close()
        janelaEscolha.un_hide()
